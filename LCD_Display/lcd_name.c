...
unsigned char sabari[size] = {"SABARISH"};

void main(void) {
    
    START_CONFIGURATION();
    
    LCD_COMMAND_TO_THE_CONTROLLER(0x82); // Data to be displayed from very start of the display
    ...
    LCD_COMMAND_TO_THE_CONTROLLER(0x04); // 000 0100 setting the initialization of cursor right to left move
    __delay_ms(100);
 
    LCD_COMMAND_TO_THE_CONTROLLER(0xCD); // Data to be displayed from very start of the display
